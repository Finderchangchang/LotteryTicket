...
import net.tsz.afinal.sqlite.ManyToOne;
import net.tsz.afinal.sqlite.OneToMany;
import net.tsz.afinal.sqlite.Property;
import net.tsz.afinal.sqlite.Transient;
